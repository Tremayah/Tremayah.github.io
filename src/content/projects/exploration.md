...
description: "A batch-production lighting study — translucent acrylic layered and lit from within, then re-made in Corian, wood and metal to see how each material looks, feels, and responds to the light."
year: 2026
...
<figure class="proj-full">
  <img loading="lazy" decoding="async" src="/images/exploration/lamp-wood.webp" alt="The wooden (larch) lamp, lit from within" />
</figure>

<section class="proj-row">
  <figure class="proj-media">
    <img loading="lazy" decoding="async" src="/images/exploration/lamp-metal.webp" alt="The stainless steel lamp" />
  </figure>
...
<section class="proj-row proj-row--rev">
  <figure class="proj-media">
    <img loading="lazy" decoding="async" src="/images/exploration/laser-cutting.webp" alt="Laser-cutting the stainless steel" />
  </figure>
...
<section class="proj-split">
  <img loading="lazy" decoding="async" class="proj-split-img" src="/images/exploration/lamp-split-left.webp" alt="" />
  ...
  <img loading="lazy" decoding="async" class="proj-split-img" src="/images/exploration/lamp-split-right.webp" alt="The stainless steel lamp, cut out" />
  <img loading="lazy" decoding="async" class="proj-split-full" src="/images/exploration/lamp-metal-cutout.webp" alt="The stainless steel lamp, cut out" />
</section>

<section class="proj-row proj-row--rev">
  <figure class="proj-media proj-media--a4">
    <img loading="lazy" decoding="async" src="/images/exploration/press-release.webp" alt="The single-page press release" />
  </figure>
...
<section class="proj-posters">
  <img loading="lazy" decoding="async" class="proj-poster-a4" src="/images/exploration/poster-a.webp" alt="'304 Sandwich Lamp' spec poster" />
  <div class="proj-poster-squares">
    <img loading="lazy" decoding="async" src="/images/exploration/poster-b.webp" alt="Dark 'Sandwich Lamp 304' poster" />
    <img loading="lazy" decoding="async" src="/images/exploration/poster-c.webp" alt="Y2K checkered sandwich lamp poster" />
  </div>
</section>
